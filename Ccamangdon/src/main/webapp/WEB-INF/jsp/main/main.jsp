...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#franchising">프랜차이즈</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">까망돈이란 검은 돼지입니다.</h3>
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-6">
            ...
            <h4 class="service-heading">소개1</h4>
            <p class="text-muted">까망돈을 소개합니다. 어쭈고 저쭈고 얄리얄리얄랴셩 절리절리아아아</p>
          </div>
          <div class="col-md-6">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading">소개2</h4>
            <p class="text-muted">또 소개합니다. 어어엉하하하하하하하하하하하하하하하하하하</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="applying-modal modal fade" id="applyingModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">프랜차이즈 문의</h5>
            ...
            <div class="row">
              <div class="modal-body">
                <div class="form-group">
                  <label for="applyingName">이름</label>
                  <input type="text" class="form-control" id="applyingName" placeholder="이름을 입력해주세요.">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="email" placeholder="Email을 입력해주세요.">
                </div>
                <div class="form-group">
